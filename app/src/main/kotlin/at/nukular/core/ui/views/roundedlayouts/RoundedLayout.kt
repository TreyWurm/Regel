...
interface RoundedLayout {
    ...
    var rippleColor: Int
    val outlineProvider: RoundedLayoutOutlineProvider

    fun updateOutlineProvider(width: Int, height: Int) {
        outlineProvider.width = width
        outlineProvider.height = height
    }
